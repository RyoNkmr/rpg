...
func Inject(player2 player.Player) (controller.RootController, error) {
	...
	commandPresenter := presenter.NewCommandPresenter(application)
	battleUsecase := usecase.NewBattleUsecase(mainPresenter, statusPresenter, inventoryPresenter, commandPresenter)
